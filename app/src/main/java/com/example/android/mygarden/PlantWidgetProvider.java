...
public class PlantWidgetProvider extends AppWidgetProvider {
    ...
    public static void updatePlantWidgets(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds, int imageRes) {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        PlantWateringService.startUpdatePlantWidgets(context);
    }
